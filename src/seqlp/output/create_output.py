...
class GenerateOutput:
    ...
    def time_dif(self,  stop):
        elapsed_time = stop - self.start_time
        elapsed_time_minutes = elapsed_time / 60
        print(f"Elapsed time: {elapsed_time_minutes} minutes")
        return int(elapsed_time_minutes)
    
    def collect_general_info(self, num_sequences:int, elapsed_time_minutes:int, num_parameters:int, command:str, model_type:str):
        general_info = {}
